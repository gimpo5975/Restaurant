...
<head>
    ...
    <script src="//dapi.kakao.com/v2/maps/sdk.js?appkey=c75eb8444a0f02b23f1411fb0d3b5fe3"></script>   
...
<body>
    ...
    %>           
                  <li><a href="list01.jsp?sectordetail=<%=sct %>" 
                         data-transition="slidedown"><img 
                         src="images/<%=img[i] %>" 
                         alt="<%=rs.getString("sectordetail") %>">
                           <h3>
                               <%=rs.getString("sectordetail") %>
                           </h3></a>
                  </li>
